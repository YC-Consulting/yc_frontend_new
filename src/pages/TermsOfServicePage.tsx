...
import { Shield, AlertTriangle, FileText, Scale, Clock, Users } from "lucide-react";
        ...
        >
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Welcome to Yichuan AI. These Terms of Service ("Terms") govern your use of our website, 
              artificial intelligence document analysis services, media resource platforms, and related 
              services provided by Yichuan AI ("Company", "we", "us", or "our").
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              information is governed by our Privacy Policy. By using our services, you consent to 
              the collection and use of your information as described in our Privacy Policy.
            </p>
            <p className="text-gray-700 leading-relaxed mt-3">
              For document analysis services, we may temporarily process your uploaded documents 
              to provide analysis results. We do not permanently store or share your documents 
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              software, and AI algorithms, is the property of Yichuan AI and is protected by 
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Some of our services may require payment. All fees are stated in USD unless otherwise 
              specified. Payment is due upon purchase, and all sales are final unless otherwise stated. 
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              shall not exceed the amount paid by you for our services in the 12 months preceding 
              the claim.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              While we strive to provide uninterrupted service, we do not guarantee that our services 
              will be available at all times. We may experience downtime for maintenance, updates, 
              or technical issues. We reserve the right to modify, suspend, or discontinue any 
              aspect of our services with reasonable notice.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              terminate or suspend your account immediately if you violate these Terms. Upon 
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              via email or website notification. Continued use of our services after changes 
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              jurisdiction where Yichuan AI is incorporated, without regard to conflict of law 
              principles.
            </p>
          </section>
          ...
          <section className="border-t pt-8">
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-700">
                <strong>Email:</strong> yichuaned@gmail.com
              </p>
